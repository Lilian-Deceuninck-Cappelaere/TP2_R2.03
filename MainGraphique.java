...
class MainGraphique{
    ...
    public static void main(String[] args){
		boolean cheat = Menu.choisir(); // demander à l'utilisateur s'il veut cheat (lancement d'une fenêtre spécifique) 

		Plateau p; // déclaration de p ici : si p est déclarer dans le if, il n'est pas disponible en dehors
		if (cheat == true){
			p = new Plateau(true); 
		}
		else {
